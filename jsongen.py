...
tk.Label(root, text="GitHub Repository").grid(row=1)
...
github_repo_entry.grid(row=1, column=1)
folder_remove_checkbutton.grid(row=2, column=1)
delete_zerobyte_checkbutton.grid(row=3, column=1)

tk.Button(root, text='Save', command=save).grid(row=4, column=0, sticky=tk.W, pady=4)
